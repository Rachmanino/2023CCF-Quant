...
# construct dataset
DataSets = []
csv_names = [csv_name[:-4] for csv_name in os.listdir('../../data/20231127')]
for csv_name in csv_names:
    DataSets.append(Stock_Dataset(data_dir='../../data/2023112', day_windows=config.day_windows+1,
...
for i in tqdm(range(len(DataSets))):
    ...
    for j in range(len(dataset)):
        data, target, data_close = dataset[j]
        THRESHOLDS = 0.01
        pnl = 0
        cnt += 1
